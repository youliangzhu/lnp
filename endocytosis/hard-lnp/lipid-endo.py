...
neighbor_list.setRCutPair('Hn', 'Hn',    2.0**(1.0/6.0)+1.6)
...
neighbor_list.setRCutPair('G', 'T1',     2.0**(1.0/6.0)+1.6)
                                        
neighbor_list.setRCutPair('G', 'Hn',    0.95*2.0**(1.0/6.0))
neighbor_list.setRCutPair('G', 'Tn',    0.95*2.0**(1.0/6.0))
neighbor_list.setRCutPair('G', 'T1n',    2.0**(1.0/6.0)+1.6)
neighbor_list.setRCutPair('G', 'G',     0.95*2.0**(1.0/6.0))
...
pf.setParams('G', 'Hn',    1.0,  0.95, 1.0, 0.95*2.0**(1.0/6.0), gala.PairFunc.lj12_6)#(,,alpha, 0.0, 0.0, rcut)
pf.setParams('G', 'Tn',    1.0,  0.95, 1.0, 0.95*2.0**(1.0/6.0), gala.PairFunc.lj12_6)#(,,alpha, 0.0, 0.0, rcut)
pf.setParams('G', 'T1n',   1.0,  0.95, 1.0,  2.0**(1.0/6.0)+1.6, gala.PairFunc.cos_wc)#(,,alpha, 0.0, 0.0, rcut)
pf.setParams('G', 'G',     1.0,  0.95, 1.0, 0.95*2.0**(1.0/6.0), gala.PairFunc.lj12_6)#(,,alpha, 0.0, 0.0, rcut)
app.add(pf)
